...
function App() {
  ...
  return (
    <main>
      ...
      <footer className="footer page-width"><a className="logo" href="#top" aria-label="Redaê — início"><img src={logoUrl} alt="Redaê" /></a><p>Uma palavra de cada vez.</p><small>© 2026 Redaê</small></footer>
    </main>
  )
}
